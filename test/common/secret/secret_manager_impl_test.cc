...
tls_certificate:
  ...
  ASSERT_EQ(secret_manager->findSecret(Secret::SecretType::TLS_CERTIFICATE, "", "undefined"),
            nullptr);

  ASSERT_NE(secret_manager->findSecret(Secret::SecretType::TLS_CERTIFICATE, "", "abc.com"),
            nullptr);
